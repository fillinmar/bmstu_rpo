...
char *personalization = "fclientmarina-sample-app";

auto logger = spdlog::android_logger_mt("android", "fclientmarina_ndk");


extern "C" JNIEXPORT jstring JNICALL
Java_ru_iu3_fclientmarina_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_ru_iu3_fclientmarina_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_ru_iu3_fclientmarina_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_fclientmarina_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_fclientmarina_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
Java_ru_iu3_fclientmarina_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd){
